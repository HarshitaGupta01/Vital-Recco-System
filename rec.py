...
# Load dataset
dataset = pd.read_csv("D:\projects\datatest\DataSet\Training.csv")
...
sym_des = pd.read_csv('D:\projects\datatest\DataSet\symtoms_df.csv')
precautions = pd.read_csv('D:\projects\datatest\DataSet\precautions_df.csv')
workout = pd.read_csv('D:\projects\datatest\DataSet\workout_df.csv')
description = pd.read_csv('D:\projects\datatest\DataSet\description.csv')
medication = pd.read_csv('D:\projects\datatest\DataSet\medications.csv')
diet = pd.read_csv('D:\projects\datatest\DataSet\diets.csv')
doctor_data=pd.read_csv("D:\projects\datatest\DataSet\Disease_Doctor_Data.csv")
...
def helper(predicted_disease):
    ...
    # return desc, pre
    return descr, pre, die,med, wrkout, doctors_list
...
descr, pre, med, die, wrkout, doctors = helper(predicted_disease)
